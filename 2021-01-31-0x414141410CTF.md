...
2021년 1월 26일 저녁에 `Ainsetin`님이 씨텝 같이 하자고, 31일까지 참여를 했었는데 많은 도움이 되지 못 한 거 같아 스스로 반성을 많이 한 대회입니다. 여튼 이번 대회에는 버스를 타서 14등을 했고, 솔브수가 그나마 적은 3 문제의 Write Up을 작성해보겠습니다.<br>

---
### (Web) Special Order pt2 [490 pts]
...
> FLAG : flag{i7_1s_n0t_s0_bl1nd3721}

---
### (Web) firstapp [496 pts]
...
![](https://github.com/wjddnjs33/image2/blob/main/0x41414141/firstapp/3.png?raw=true)
